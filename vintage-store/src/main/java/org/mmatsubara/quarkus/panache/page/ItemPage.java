package org.mmatsubara.quarkus.panache.page;

import io.quarkus.panache.common.Sort;
import io.quarkus.qute.CheckedTemplate;
import io.quarkus.qute.TemplateInstance;
import org.mmatsubara.quarkus.panache.model.Book;
import org.mmatsubara.quarkus.panache.model.CD;
...
public class ItemPage {
  ...
  @GET
  @Path("/books/{id}")
  public TemplateInstance showBooksById(@PathParam("id") Long id) {
  ...
  @GET
  @Path("/cds/{id}")
  public TemplateInstance showCdsById(@PathParam("id") Long id) {
